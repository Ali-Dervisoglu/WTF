...
// `21.11.2004` `beşiktaş` - `çaykur` `rizespor` maçı'nın devre arası'nda,
// kapalı tribün'de çıkan kavga'da bıçaklanan
// `16` yaşındaki
// `cihat aktaş`, 
// kaldırıldığı`hastane`de`hakk'ın rahmetine kavuştu`.
// polis, 
// ((karşılaşma sonrası kapalı tribünün çıkışlarını kapatarak)
// (güvenlik kamerasından tespit ettiği 3 kişiyi)) gözaltına aldı.
// gözaltına alınanlardan biri suçunu itiraf etti.
